...
struct EmojiArtDocumentView: View {
    ...
    private func pasteBackground() {
        ...
        if let imageData = UIPasteboard.general.image?.jpegData(compressionQuality: 1.0) {
            ...
            alertToShow = IdentifiableAlert(title: "Paste Background", message: "There is no image in the board.")
        }
    }
    ...
    @SceneStorage("EmojiArtDocumentView.stedyStateZoomScale") private var steadyStateZoomScale: CGFloat = 1
    @GestureState private var gestureZoomScale: CGFloat = 1

    @SceneStorage("EmojiArtDocumentView.stedyStatePanOffset") private var steadyStatePanOffset: CGSize = CGSize.zero
